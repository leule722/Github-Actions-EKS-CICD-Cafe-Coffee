...
![workflow-diagram](https://github.com/leule722/Github-Actions-EKS-CICD-Cafe-Coffee/assets/100375390/18fc51ab-7ccc-4971-a37c-9e740b854331)
...
## Now work on terminal - 
  ...
  - Now, execute below commands one by one
    ...
    ```bash
    git clone https://github.com/leule722/Github-Actions-EKS-CICD-Cafe-Coffee.git
    ```
    ```bash
